...
def observe_ingest(sess=None,tenant_id=None,obsv_site=None,payload=None, btok=None, extras=None):
    ...
    if sess is not None:
        try:
            ...
            resp = sess.post(url,headers=headers,data=payload,params=extras)
